...
#
# Terraform plan/apply 는 .github/workflows/ 가 아닌 **Atlantis** (AWS-Demo-Platform repo
...
assert_grep "AtlantisIRSARole" "docs/operations/atlantis-setup.md" "atlantis-setup names the IRSA role"
